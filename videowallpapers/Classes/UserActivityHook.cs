...
namespace videowp
{
    ...
    public class UserActivityHook
    {
        ...
        /// <summary>
        /// Структура MOUSEHOOKSTRUCT содержит информацию о событии мыши, переданном процедуре ловушки WH_MOUSE, MouseProc.
        /// </summary>
        /// <remarks>
        ...
        private class MouseHookStruct
        {
            ...
            public int hwnd;
            /// <summary>
            /// Указывает значение проверки попадания. Список значений проверки попадания см. в описании сообщения WM_NCHITTEST.
            /// </summary>
            public int wHitTestCode;
            /// <summary>
            /// Указывает дополнительную информацию, связанную с сообщением 
            /// </summary>
        ...
        private class MouseLLHookStruct
        {
            public POINT pt;
            /// <summary>
            /// Если сообщение WM_MOUSEWHEEL, старшее слово этого члена является дельтой колеса. Младшее слово зарезервировано. 
            /// Положительное значение - колесо повернуто вперед от пользователя; 
            /// отрицательное значение - колесо повернуто назад, к пользователю. 
            /// Один щелчок колеса - WHEEL_DELTA, что равно 120. Если сообщение WM_XBUTTONDOWN, WM_XBUTTONUP, WM_XBUTTONDBLCLK,
            /// WM_NCXBUTTONDOWN, WM_NCXBUTTONUP или WM_NCXBUTTONDBLCLK, старшее слово указывает, какая кнопка X была нажата или отпущена, 
            /// а младшее слово — сдержанный. Это значение может быть одним или несколькими из следующих значений. 
            /// В противном случае mouseData не используется.. 
            ///XBUTTON1
            ...
            /// <summary>
            ///Указывает флаг внедрения события. Приложение может использовать следующее значение для проверки флагов мыши. Value Purpose 
        ...
        /// <summary>
        /// Происходит, когда пользователь нажимает клавишу
        /// </summary>
